                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Set Date">
                                    <ItemTemplate>
                                        ...
                                        <img class="dateclick" src="admintemplate/PostCardImages/calender.png" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Delete">
                                    <ItemTemplate>
                                        <a id="id" href="GreetingsList.aspx?Id=<%#Eval("GreetingsId") %>">
                                            <img src="../PostCardImages/delete.png" alt="" /></a>
                                    </ItemTemplate>
                                    
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Print">
                                    <ItemTemplate>
                                        <a id="print" class="cls_print" data-id="<%#Eval("GreetingsId") %>" href="#"><img src="admintemplate/PostCardImages/print-icon.png" alt="" /></a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
